...
<div class="breadcrumb-wrapper">
    <div class="book1">
        <img src="{URL}assets/img/hero/book1.png" alt="book">
    </div>
    <div class="book2">
        <img src="{URL}assets/img/hero/book2.png" alt="book">
    </div>
    <div class="container">
                        ...
                        <div class="tab-content">
                            <div id="thumb1" class="tab-pane fade show active">
                                <div class="shop-details-thumb">
                                    <img src="{URL}assets/img/shop-details/01.png" alt="img">
                                </div>
                            </div>
                            <div id="thumb2" class="tab-pane fade">
                                <div class="shop-details-thumb">
                                    <img src="{URL}assets/img/shop-details/02.png" alt="img">
                                </div>
                            </div>
                            <div id="thumb3" class="tab-pane fade">
                                <div class="shop-details-thumb">
                                    <img src="{URL}assets/img/shop-details/03.png" alt="img">
                                </div>
                            </div>
                            <div id="thumb4" class="tab-pane fade">
                                <div class="shop-details-thumb">
                                    <img src="{URL}assets/img/shop-details/04.png" alt="img">
                                </div>
                            </div>
                            <div id="thumb5" class="tab-pane fade">
                                <div class="shop-details-thumb">
                                    <img src="{URL}assets/img/shop-details/05.png" alt="img">
                                </div>
                            </div>
                        </div>
                        <ul class="nav">
                            <li class="nav-item">
                                <a href="#thumb1" data-bs-toggle="tab" class="nav-link active">
                                    <img src="{URL}assets/img/shop-details/sm-1.png" alt="img">
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#thumb2" data-bs-toggle="tab" class="nav-link">
                                    <img src="{URL}assets/img/shop-details/sm-2.png" alt="img">
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#thumb3" data-bs-toggle="tab" class="nav-link">
                                    <img src="{URL}assets/img/shop-details/sm-3.png" alt="img">
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#thumb4" data-bs-toggle="tab" class="nav-link">
                                    <img src="{URL}assets/img/shop-details/sm-4.png" alt="img">
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#thumb5" data-bs-toggle="tab" class="nav-link">
                                    <img src="{URL}assets/img/shop-details/sm-5.png" alt="img">
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-7">
                    <div class="shop-details-content">
                        ...
                        <div class="cart-wrapper">
                            ...
                            <div class="icon-box">
                                ...
                                <a href="shop-details.html" class="icon-2">
                                    <img src="{URL}assets/img/icon/shuffle.svg" alt="svg-icon">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="social-icon">
                            ...
                            <a href="https://www.customer.io/"><img src="{URL}assets/img/cutomerio.png" alt="cutomer.io"></a>
                            <a href="https://www.amazon.com/"><img src="{URL}assets/img/amazon.png" alt="amazon"></a>
                            <a href="https://www.dropbox.com/"><img src="{URL}assets/img/dropbox.png" alt="dropbox"></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="review-items">
                            <div class="review-wrap-area d-flex gap-4">
                                <div class="review-thumb">
                                    <img src="{URL}assets/img/shop-details/review.png" alt="img">
                                </div>
        ...
        <div class="swiper book-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="shop-box-items style-2">
                        <div class="book-thumb center">
                            <a href="shop-details-2.html"><img src="{URL}assets/img/book/01.png" alt="img"></a>
                            <ul class="post-box">
                                <li>
                                    Hot
                                </li>
                            ...
                            <ul class="shop-icon d-grid justify-content-center align-items-center">
                                ...
                                <li>
                                    <a href="shop-cart.html">
                                        ...
                                        <img class="icon" src="{URL}assets/img/icon/shuffle.svg" alt="svg-icon">
                                    </a>
                                </li>
                                <li>
                        ...
                        <div class="shop-content">
                            ...
                            <ul class="author-post">
                                <li class="authot-list">
                                        <span class="thumb">
                                            <img src="{URL}assets/img/testimonial/client-1.png" alt="img">
                                        </span>
                ...
                <div class="swiper-slide">
                    <div class="shop-box-items style-2">
                        <div class="book-thumb center">
                            <a href="shop-details-2.html"><img src="{URL}assets/img/book/02.png" alt="img"></a>
                            <ul class="shop-icon d-grid justify-content-center align-items-center">
                                <li>
                                    <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                </li>
                        ...
                        <div class="shop-content">
                            ...
                            <ul class="author-post">
                                <li class="authot-list">
                                        <span class="thumb">
                                            <img src="{URL}assets/img/testimonial/client-2.png" alt="img">
                                        </span>
                ...
                <div class="swiper-slide">
                    <div class="shop-box-items style-2">
                        <div class="book-thumb center">
                            <a href="shop-details-2.html"><img src="{URL}assets/img/book/03.png" alt="img"></a>
                            <ul class="shop-icon d-grid justify-content-center align-items-center">
                                <li>
                                    <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                </li>
                        ...
                        <div class="shop-content">
                            ...
                            <ul class="author-post">
                                <li class="authot-list">
                                        <span class="thumb">
                                            <img src="{URL}assets/img/testimonial/client-3.png" alt="img">
                                        </span>
                ...
                <div class="swiper-slide">
                    <div class="shop-box-items style-2">
                        <div class="book-thumb center">
                            <a href="shop-details-2.html"><img src="{URL}assets/img/book/04.png" alt="img"></a>
                            <ul class="post-box">
                                <li>
                                    Hot
                                </li>
                        ...
                        <div class="shop-content">
                            ...
                            <ul class="author-post">
                                <li class="authot-list">
                                        <span class="thumb">
                                            <img src="{URL}assets/img/testimonial/client-4.png" alt="img">
                                        </span>
                ...
                <div class="swiper-slide">
                    <div class="shop-box-items style-2">
                        <div class="book-thumb center">
                            <a href="shop-details-2.html"><img src="{URL}assets/img/book/05.png" alt="img"></a>
                            <ul class="shop-icon d-grid justify-content-center align-items-center">
                                <li>
                                    <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                </li>
                        ...
                        <div class="shop-content">
                            ...
                            <ul class="author-post">
                                <li class="authot-list">
                                        <span class="thumb">
                                            <img src="{URL}assets/img/testimonial/client-5.png" alt="img">
                                        </span>
